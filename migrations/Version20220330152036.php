 ...
 */
final class Version20220330152036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD recipient_name VARCHAR(50) NOT NULL, ADD address_delivery LONGTEXT NOT NULL, ADD recipient_phone VARCHAR(11) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP recipient_name, DROP address_delivery, DROP recipient_phone, CHANGE status status VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
