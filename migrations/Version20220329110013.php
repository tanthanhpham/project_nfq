 ...
 */
final class Version20220329110013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD create_at DATETIME NOT NULL, ADD update_at DATETIME NOT NULL');
    }
