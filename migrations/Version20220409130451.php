 ...
 */
final class Version20220409130451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE reason_cancel reason_cancel LONGTEXT DEFAULT NULL, CHANGE subject_cancel subject_cancel VARCHAR(100) DEFAULT NULL');
    }
