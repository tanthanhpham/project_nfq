 ...
 */
final class Version20220420090937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD token VARCHAR(50) DEFAULT NULL');
    }
