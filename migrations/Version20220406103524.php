...
final class Version20220406103524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD total_price BIGINT NOT NULL, ADD total_quantity INT NOT NULL');
