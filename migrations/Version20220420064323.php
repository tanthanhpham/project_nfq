 ...
 */
final class Version20220420064323 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD token VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE transaction_id transaction_id VARCHAR(40) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE currency_code currency_code VARCHAR(40) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status status VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
