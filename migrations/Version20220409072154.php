 ...
 */
final class Version20220409072154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD shipping_cost INT DEFAULT NULL');
    }
