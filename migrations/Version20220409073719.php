 ...
 */
final class Version20220409073719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE shipping_cost shipping_cÃost INT DEFAULT NULL');
    }
